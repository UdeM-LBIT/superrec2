...
% gene branches
\draw[branch={reccolor0}] (308.4133,64.5) |- (466.4499,43.75) (474.9499,43.75) -| (595.9248,162.8865);
...
\draw[branch={reccolor0}] (459.6999,54.75) |- (442.7549,22.75) (487.6449,22.75) -| (470.6999,39.5);
\draw[branch={reccolor0}] (134.8599,136.0165) |- (350.0358,96.7866) (358.5358,96.7866) -| (435.7549,223.4965);
\path[branch={reccolor0}] (354.2858,74.5) -- (354.2858,64.5);
\draw[branch={reccolor0}] (354.2858,92.5366) |- (354.2858,88.5366);
\draw[branch={reccolor0}] (145.8599,136.0165) |- (300.7058,112.7766) (345.0358,112.7766) -| (399.2299,223.4965);
...
\draw[branch={reccolor0}] (293.9558,126.2665) |- (304.1633,84.2866) (312.6633,84.2866) -| (322.8708,106.0366);
\path[branch={reccolor0}] (177.5549,150.0165) -- (177.5549,136.0165);
\draw[branch={reccolor0}] (63.025,223.4965) |- (155.1099,156.8215) (199.9999,156.8215) -| (313.1199,193.6265);
\path[branch={reccolor0}] (145.8599,168.6265) -- (145.8599,136.0165);
\draw[branch={reccolor0}] (21.915,223.4965) |- (141.6099,172.8765) (150.1099,172.8765) -| (260.2799,193.6265);
...
\draw[branch={reccolor0}] (252.9899,233.4965) |- (219.5799,222.8115) (254.7399,222.8115) -| (221.3299,233.4965);
\path[branch={reccolor0}] (260.2799,203.6265) -- (260.2799,193.6265);
\draw[branch={reccolor0}] (283.3999,233.4965) |- (256.0299,207.8765) (264.5299,207.8765) -| (237.1599,216.1265);
...
\draw[branch={reccolor0}] (493.3949,206.1265) |- (573.4798,183.6915) (618.3698,183.6915) -| (662.4823,198.4965);
\path[branch={reccolor0}] (543.6724,216.1265) -- (543.6724,206.1265);
\draw[branch={reccolor0}] (557.1449,233.4965) |- (525.8124,222.8115) (561.5324,222.8115) -| (530.1999,233.4965);
\path[branch={reccolor0}] (493.3949,233.4965) -- (493.3949,206.1265);
\draw[branch={reccolor0}] (680.3998,233.4965) |- (658.2323,225.2465) (666.7323,225.2465) -| (644.5648,233.4965);
\path[branch={reccolor0}] (662.4823,208.4965) -- (662.4823,198.4965);
\draw[branch={reccolor0}] (662.4823,220.9965) |- (662.4823,216.9965);
% gene transfers
\draw[transfer branch={reccolor0}] (379.3141,81.5183) to[out=0, in=180] (543.6724,206.1265);
\draw[transfer branch={reccolor0}] (657.2323,212.7465) to[out=180, in=0] (363.9549,223.4965);
% events
