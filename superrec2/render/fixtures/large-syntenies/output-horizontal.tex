...
% gene branches
\draw[branch={reccolor0}] (83.89,142.6407) -| (63.14,211.4797) (63.14,219.9797) |- (255.6566,271.8846);
...
\draw[branch={reccolor0}] (74.14,204.7297) -| (32.445,197.4797) (32.445,222.9797) |- (58.89,215.7297);
\draw[branch={reccolor0}] (222.2766,50.7099) -| (152.1966,161.1256) (152.1966,169.6256) |- (350.5966,195.7948);
\path[branch={reccolor0}] (93.89,165.3756) -- (83.89,165.3756);
\draw[branch={reccolor0}] (147.9466,165.3756) |- (143.9466,165.3756);
\draw[branch={reccolor0}] (222.2766,61.7099) -| (183.6116,142.6457) (183.6116,156.1256) |- (350.5966,181.8698);
...
\draw[branch={reccolor0}] (212.5266,135.8957) -| (139.6966,138.3907) (139.6966,146.8907) |- (161.4466,149.3857);
\path[branch={reccolor0}] (236.2766,77.7649) -- (222.2766,77.7649);
\draw[branch={reccolor0}] (350.5966,22.535) -| (258.7216,70.9599) (258.7216,84.5699) |- (311.1666,138.7798);
\path[branch={reccolor0}] (286.1666,61.7099) -- (222.2766,61.7099);
\draw[branch={reccolor0}] (350.5966,8.49) -| (290.4166,57.4599) (290.4166,65.9599) |- (311.1666,114.3699);
...
\draw[branch={reccolor0}] (372.8266,110.8749) -| (351.2466,97.2549) (351.2466,110.6249) |- (372.8266,97.0049);
\path[branch={reccolor0}] (321.1666,114.3699) -- (311.1666,114.3699);
\draw[branch={reccolor0}] (375.3266,124.7998) -| (325.4166,110.1199) (325.4166,118.6199) |- (333.6666,103.9399);
...
\draw[branch={reccolor0}] (322.5466,224.7847) -| (292.1016,265.0796) (292.1016,278.6896) |- (326.0965,298.2671);
\path[branch={reccolor0}] (332.5466,245.7097) -- (322.5466,245.7097);
\draw[branch={reccolor0}] (382.8166,252.6447) -| (350.4066,239.0247) (350.4066,252.3947) |- (372.2666,238.7747);
\path[branch={reccolor0}] (363.0966,224.7847) -- (322.5466,224.7847);
\draw[branch={reccolor0}] (374.2066,305.2896) -| (354.8466,294.0171) (354.8466,302.5171) |- (363.0966,291.2446);
\path[branch={reccolor0}] (336.0965,298.2671) -- (326.0965,298.2671);
\draw[branch={reccolor0}] (350.5966,298.2671) |- (346.5966,298.2671);
% gene transfers
\draw[transfer branch={reccolor0}] (118.9183,172.3939) to[out=-90, in=90] (322.5466,245.7097);
\draw[transfer branch={reccolor0}] (341.3465,294.0171) to[out=90, in=-90] (350.5966,167.8248);
% events
