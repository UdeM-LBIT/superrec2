...
% gene branches
\draw[branch={reccolor0}] (78.5,70.8199) -| (39.25,131.3999) (39.25,139.8999) |- (136.84,156.7448);
\draw[branch={reccolor0}] (78.5,57.3199) -| (52.75,117.8999) (52.75,126.3999) |- (136.84,145.8648);
\draw[branch={reccolor0}] (78.5,43.8199) -| (66.25,104.3999) (66.25,112.8999) |- (136.84,135.0548);
\draw[branch={reccolor0}] (48.5,122.1499) -| (26.75,111.1499) (26.75,119.6499) |- (62.0,108.6499);
\path[branch={reccolor0}] (10.0,125.5249) -- (0,125.5249);
\draw[branch={reccolor0}] (35.0,135.6499) -| (14.25,121.2749) (14.25,129.7749) |- (22.5,115.3999);
\path[branch={reccolor0}] (92.5,70.8199) -- (78.5,70.8199);
\draw[branch={reccolor0}] (136.0,28.5949) -| (96.75,66.5699) (96.75,75.0699) |- (136.0,108.9699);
\path[branch={reccolor0}] (106.0,57.3199) -- (78.5,57.3199);
\draw[branch={reccolor0}] (136.0,17.715) -| (110.25,53.0699) (110.25,61.5699) |- (136.0,97.6099);
\path[branch={reccolor0}] (119.5,43.8199) -- (78.5,43.8199);
\draw[branch={reccolor0}] (136.0,6.905) -| (123.75,39.5699) (123.75,48.0699) |- (136.0,86.2499);
